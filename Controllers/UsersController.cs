...
namespace FormAuthentication.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            var databaseContext = _context.Users.Include(u => u.UserRole);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FirstName,LastName,Email,Password,UserRoleID,isConfirmed,ActivationCode,ID,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate")] User user)
        {
            if (id != user.ID)
            {
                return NotFound();
